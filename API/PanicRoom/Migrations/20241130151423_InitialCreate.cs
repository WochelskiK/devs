        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalInformations = table.Column<string>(type: "text", nullable: false),
                    CategoryID = table.Column<int>(type: "integer", nullable: false),
                    IssueStatusEnum = table.Column<int>(type: "integer", nullable: false),
                    IssuePriorityEnum = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Issues_AspNetUsers_UserAssignedID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairProtocols", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepairProtocols_Issues_IssueID",
                        column: x => x.IssueID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_UserAssignedID",
                table: "Issues",
                column: "UserAssignedID");

            migrationBuilder.CreateIndex(
                name: "IX_RepairProtocols_IssueID",
                table: "RepairProtocols",
                column: "IssueID",
                unique: true);
